    ...
    <div className="mx-auto max-w-4xl px-4 py-12 md:py-16 animate-fade-in-up">
      ...
      <div className="bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-8 md:p-10 shadow-xl shadow-slate-100/50 dark:shadow-none backdrop-blur-xl">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-900/50 border border-slate-200/40 dark:border-slate-800 flex items-center justify-center text-slate-500 shrink-0">
        ...
        <div className="space-y-8 text-[15px] text-slate-600 dark:text-slate-300 leading-relaxed ml-0 md:ml-13">
          <section>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-200 mb-2">1. Description of service</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-200 mb-2">2. "As is" provision</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-200 mb-2">3. File storage & deletion</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-200 mb-2">4. User responsibility</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-slate-800 dark:text-slate-200 mb-2">5. Limitation of liability</h2>
            <p>
