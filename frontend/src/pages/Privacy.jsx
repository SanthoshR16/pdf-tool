    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
        ...
        <div className="space-y-6 text-slate-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-slate-800 mb-3">1. No Permanent Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 mb-3">2. No AI Training</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 mb-3">3. No Third-Party APIs or Cloud AI</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 mb-3">4. Zero Account Tracking</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-slate-800 mb-3">5. Data Deletion Guarantee</h2>
