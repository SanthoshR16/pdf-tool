  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        {/* Info Card */}
        <div className="md:col-span-5 bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-8 text-white shadow-md flex flex-col justify-between">
          <div>
        ...
        {/* Contact Form */}
        <div className="md:col-span-7 bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-indigo-500 focus:outline-none transition duration-150"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-indigo-500 focus:outline-none transition duration-150 resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-indigo-600 text-white rounded-xl py-3 text-sm font-bold shadow-md hover:bg-indigo-700 active:scale-[0.98] transition flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {loading ? (
